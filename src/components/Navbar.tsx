...
// import logo from '../assets/images/Hously Logo final.png';
...
//       {/* Hero Section with Background Slider - Only on Home Page */}
//       {isHomePage && (
...
//     <div className="bg-white rounded-[1.5rem] shadow-2xl px-2 py-3 sm:py-2 backdrop-blur-sm bg-white/95">
...
//             src={logo} 
//             alt="Hously Logo" 
//             className="h-8 sm:h-14 w-auto pl-3 sm:pl-6"
//           />
//         </Link>

//         {/* Desktop Menu */}
//         <div className="hidden lg:flex items-center space-x-12">
//           <Link to="/" className="text-gray-700 hover:text-[#0076d8] transition font-medium relative group">
//             Home
//             <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#0076d8] transition-all group-hover:w-full"></span>
//           </Link>
//           <a href="/services" className="text-gray-700 hover:text-[#0076d8] transition font-medium relative group">
//             Services
//             <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#0076d8] transition-all group-hover:w-full"></span>
//           </a>
//           <Link to="/about" className="text-gray-700 hover:text-[#0076d8] transition font-medium relative group">
//             About
//             <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#0076d8] transition-all group-hover:w-full"></span>
//           </Link>
//           <a href="/contact" className="text-gray-700 hover:text-[#0076d8] transition font-medium relative group">
//             Contact
//             <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#0076d8] transition-all group-hover:w-full"></span>
//           </a>
//           <a href="/career" className="text-gray-700 hover:text-[#0076d8] transition font-medium relative group">
//             Career
//             <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#0076d8] transition-all group-hover:w-full"></span>
//           </a>
//         </div>
...
//           <button className="p-2.5 hover:bg-gray-100 rounded-full transition hover:rotate-90 duration-300">
//             <svg className="w-5 h-5 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//               <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
//             </svg>
//           </button>
          
//           <button className="bg-[#0076d8] hover:bg-[#0066c0] text-white px-7 py-3.5 rounded-full transition font-semibold shadow-lg shadow-[#0076d8]/30 flex items-center space-x-2 hover:shadow-xl hover:shadow-[#0076d8]/50 transform hover:scale-105">
//             <span>Get A Quote</span>
//           </button>
          
//           <button className="p-2.5 hover:bg-gray-100 rounded-lg transition hover:rotate-180 duration-300">
//             <div className="grid grid-cols-3 gap-1">
//               {[...Array(9)].map((_, i) => (
//                 <div key={i} className="w-1.5 h-1.5 bg-[#0076d8] rounded-full"></div>
//               ))}
//             </div>
//           </button>
//         </div>
...
//             className="text-gray-700 p-2 hover:bg-gray-100 rounded transition"
//           >
...
//       {/* Mobile Menu */}
//       {isOpen && (
//         <div className="lg:hidden mt-3 pt-3 border-t border-gray-200 animate-fadeIn">
//           <div className="space-y-1">
//             <Link to="/" className="block px-4 py-2 text-gray-700 hover:text-[#0076d8] hover:bg-gray-50 rounded-lg font-medium transition">Home</Link>
//             <a href="/services" className="block px-4 py-2 text-gray-700 hover:text-[#0076d8] hover:bg-gray-50 rounded-lg font-medium transition">Services</a>
//             <Link to="/about" className="block px-4 py-2 text-gray-700 hover:text-[#0076d8] hover:bg-gray-50 rounded-lg font-medium transition">About</Link>
//             <a href="/contact" className="block px-4 py-2 text-gray-700 hover:text-[#0076d8] hover:bg-gray-50 rounded-lg font-medium transition">Contact</a>
//             <a href="/career" className="block px-4 py-2 text-gray-700 hover:text-[#0076d8] hover:bg-gray-50 rounded-lg font-medium transition">Career</a>
...
//           {/* Hero Content */}
//           <div className="relative z-10 flex items-center justify-center" style={{ minHeight: 'calc(100vh - 180px)' }}>
...
//       hover:shadow-2xl hover:shadow-[#0076d8]/50 group"
//   >
...
//           {/* Slider Controls */}
//           <div className="absolute bottom-2 left-0 right-0 z-20 flex justify-center items-center space-x-4">
//             <button 
//               onClick={prevSlide}
...
//                     index === currentSlide 
//                       ? 'w-10 h-2.5 bg-[#ffd801] shadow-lg shadow-[#ffd801]/50' 
...
//       {/* Simple Navbar for Other Pages */}
// {!isHomePage && (
//   <nav className="sticky top-4 z-50  ">
//     <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
//       <div className="bg-white rounded-[1rem] shadow-2xl px-2 py-4 backdrop-blur-sm bg-white/95">
...
//                 key={item.name}
//                 to={item.path}
//                 className="text-gray-700 hover:text-[#0076d8] transition font-medium relative group"
//               >
//                 {item.name}
//                 <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#0076d8] transition-all group-hover:w-full"></span>
//               </Link>
...
//           {/* Right Side */}
//           <div className="hidden lg:flex items-center space-x-4">
//             <button className="bg-[#0076d8] hover:bg-[#0066c0] text-white px-7 py-3.5 rounded-full transition font-semibold shadow-lg shadow-[#0076d8]/30 hover:scale-105">
//               Get A Quote
//             </button>
//           </div>
...
//               <Link to="/" className="block px-4 py-2 rounded-lg hover:bg-gray-50">Home</Link>
//                             <a href="/services" className="block px-4 py-2 rounded-lg hover:bg-gray-50">Services</a>

//               <Link to="/about" className="block px-4 py-2 rounded-lg hover:bg-gray-50">About</Link>
//                             <a href="/contact" className="block px-4 py-2 rounded-lg hover:bg-gray-50">Contact</a>

//               <a href="/career" className="block px-4 py-2 rounded-lg hover:bg-gray-50">Career</a>

//               <button className="w-full mt-3 bg-[#0076d8] text-white px-6 py-3 rounded-full font-semibold">
//                 Get A Quote
//               </button>
//             </div>
//           </div>
...
//       {/* Navbar - Now outside hero section */}
//       <nav className="sticky top-0 z-50 pt-4">
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//           <div className="bg-white rounded-[1.5rem] shadow-2xl px-2 py-2.5 sm:py-2 backdrop-blur-sm bg-white/95">
//             <div className="flex justify-between items-center">
//               {/* Logo */}
//               <Link to="/" className="flex items-center">
//                 <img 
//                   src={logo} 
//                   alt="Hously Logo" 
//                   className="h-9 sm:h-14 w-auto pl-3 sm:pl-6"
//                 />
//               </Link>
...
//                   <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#0076d8] transition-all group-hover:w-full"></span>
//                 </Link>
//                 <Link to="/services" className="text-gray-700 hover:text-[#0076d8] transition font-medium relative group">
//                   Services
//                   <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#0076d8] transition-all group-hover:w-full"></span>
//                 </Link>
//                 <Link to="/about" className="text-gray-700 hover:text-[#0076d8] transition font-medium relative group">
...
//                   <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#0076d8] transition-all group-hover:w-full"></span>
//                 </Link>
//                 <Link to="/contact" className="text-gray-700 hover:text-[#0076d8] transition font-medium relative group">
//                   Contact
//                   <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#0076d8] transition-all group-hover:w-full"></span>
//                 </Link>
//                 <Link to="/career" className="text-gray-700 hover:text-[#0076d8] transition font-medium relative group">
//                   Career
//                   <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#0076d8] transition-all group-hover:w-full"></span>
//                 </Link>
//               </div>
...
//                   className="p-2.5 hover:bg-gray-100 rounded-lg transition hover:rotate-180 duration-300"
//                 >
//                   <div className="grid grid-cols-3 gap-1">
//                     {[...Array(9)].map((_, i) => (
//                       <div key={i} className="w-1.5 h-1.5 bg-[#0076d8] rounded-full"></div>
...
//               <div className="lg:hidden mt-3 pt-3 border-t border-gray-200 animate-fadeIn">
//                 <div className="space-y-1">
//                   <Link to="/" onClick={() => setIsOpen(false)} className="block px-4 py-2 text-gray-700 hover:text-[#0076d8] hover:bg-gray-50 rounded-lg font-medium transition">Home</Link>
//                   <Link to="/services" onClick={() => setIsOpen(false)} className="block px-4 py-2 text-gray-700 hover:text-[#0076d8] hover:bg-gray-50 rounded-lg font-medium transition">Services</Link>
//                   <Link to="/about" onClick={() => setIsOpen(false)} className="block px-4 py-2 text-gray-700 hover:text-[#0076d8] hover:bg-gray-50 rounded-lg font-medium transition">About</Link>
//                   <Link to="/contact" onClick={() => setIsOpen(false)} className="block px-4 py-2 text-gray-700 hover:text-[#0076d8] hover:bg-gray-50 rounded-lg font-medium transition">Contact</Link>
//                   <Link to="/career" onClick={() => setIsOpen(false)} className="block px-4 py-2 text-gray-700 hover:text-[#0076d8] hover:bg-gray-50 rounded-lg font-medium transition">Career</Link>
//                   <button className="w-full mt-2 bg-[#0076d8] hover:bg-[#0066c0] text-white px-6 py-2.5 rounded-full transition font-semibold transform hover:scale-105">
//                     Get A Quote
//                   </button>
//                 </div>
...
//       {isHomePage && (
//         <div className="relative min-h-screen overflow-hidden -mt-28">
//           {/* Background Images with Transition */}
//           {slides.map((slide, index) => (
//             <div
//               key={index}
