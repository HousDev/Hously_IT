  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        {/* Hero Section */}
         {/* Hero Section */}
      <div className="bg-[#dbeafe] text-black py-16 px-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-sm">
                      Tamara Uprise, Rahatani Road<br />
                      Beside Reliance Smart Point<br />
                      Near SNBP School, Madhuban Colony<br />
