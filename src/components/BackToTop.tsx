  ...
  return (
    <>
      {isVisible && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 z-50 p-3 bg-[#0076d8] text-white rounded-full shadow-lg hover:bg-[#0066c0] transition-all duration-300 hover:shadow-xl hover:scale-110 focus:outline-none focus:ring-2 focus:ring-[#0076d8] focus:ring-offset-2"
