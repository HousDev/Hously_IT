  ...
  return (
    <div className="w-full">
      ...
      <div className="hidden lg:block">
        {/* About Section */}
        <section className="pt-17 md:pt-1 pb-16 md:pb-20 lg:pb-12 bg-white overflow-hidden">
      ...
      <div className="block lg:hidden">
        ...
        <section className="pt-12 pb-16 bg-white px-4">
          ...
          <div className="mb-12">
            <span className="inline-block text-[#0076d8] font-medium uppercase tracking-wider mb-4 text-sm">
              About Us
            </span>
          ...
          <div className="relative">
            ...
            <div className="relative">
              <div className="rounded-3xl overflow-hidden border-4 border-white shadow-lg mb-8">
                <img
                  alt="img"
                  src="https://html.themehour.net/robor/demo/assets/img/normal/about-thumb4-2.jpg"
                  className="w-full h-auto"
        ...
        <section className="relative overflow-hidden bg-[#F5F5F5] py-16 px-4">
          {/* Background Image */}
          <div
