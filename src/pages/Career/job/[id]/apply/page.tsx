...
import { 
  ...
  Linkedin, Globe, Briefcase, Calendar, MapPin, 
  DollarSign, CheckCircle, AlertCircle, X 
} from "lucide-react";
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 flex items-center justify-center px-4">
        <div className="max-w-md bg-white rounded-2xl shadow-xl p-8 text-center animate-fade-in">
          ...
          <p className="text-gray-600 mb-6">
            Thank you for applying for the <span className="font-semibold">{job.title}</span> position at {job.company}. 
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600">{job.company} • {job.type.join(" • ")}</p>
            </div>
            <div className="flex items-center space-x-4">
              <span className="hidden md:inline text-sm text-gray-500">Ref:</span>
          ...
          <div className="lg:w-3/5">
            <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl md:text-2xl font-bold text-gray-900">Application Form</h2>
                <div className="text-sm text-gray-500">
                  Step 1 of 2 • <span className="text-blue-600 font-medium">Personal Details</span>
                </div>
              </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 border ${formErrors.fullName ? 'border-red-300' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors`}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-full px-4 py-3 border ${formErrors.email ? 'border-red-300' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors`}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-full px-4 py-3 border ${formErrors.phone ? 'border-red-300' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors`}
      ...
      {formErrors.resume}
                ...
                {/* <div>
                  ...
                  <p className="mt-2 text-sm text-gray-500">
                    Tip: Mention specific skills or experiences that make you a perfect candidate.
                  </p>
                </div> */}
                    ...
                    <button
                      ...
                      className={`flex-1 py-4 rounded-lg font-bold text-lg transition-all flex items-center justify-center ${
                        isSubmitting
                          ...
                          : "bg-gradient-to-r from-[#0270e1] to-[#024a9e] hover:from-[#024a9e] hover:to-[#0270e1] hover:shadow-lg transform hover:-translate-y-0.5"
                      } text-white`}
                    >
                      {isSubmitting ? (
                        <>
...
<ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-700">
                  <li className="flex items-start p-2 hover:bg-white/50 rounded transition-colors">
                    ...
                    <span>Ensure your resume is updated and matches the job requirements</span>
                  </li>
                  <li className="flex items-start p-2 hover:bg-white/50 rounded transition-colors">
                    <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                      <span className="text-blue-600 font-bold text-xs">2</span>
                    </div>
                    <span>Customize your cover letter to highlight relevant experience</span>
                  </li>
                  <li className="flex items-start p-2 hover:bg-white/50 rounded transition-colors">
                    <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                      <span className="text-blue-600 font-bold text-xs">3</span>
                    </div>
                    <span>Double-check all contact information for accuracy</span>
                  </li>
                  <li className="flex items-start p-2 hover:bg-white/50 rounded transition-colors">
                    <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                      <span className="text-blue-600 font-bold text-xs">4</span>
                    </div>
                    <span>Include links to your portfolio or relevant projects</span>
                  </li>
                </ul>
              </div>
